...
SimpleCov.command_name(ENV.fetch('CUKE_SLICER_SIMPLECOV_COMMAND_NAME'))
...
# TODO: Condition still needed?
# The Lcov formatter needs at least version 0.18 of SimpleCov but earlier versions may be in use due to CI needs
formatters << SimpleCov::Formatter::LcovFormatter unless major.zero? && (minor < 18)

SimpleCov.formatter = SimpleCov::Formatter::MultiFormatter.new(formatters)

SimpleCov.start do
  root __dir__
  coverage_dir "#{ENV.fetch('CUKE_SLICER_REPORT_FOLDER')}/coverage"
